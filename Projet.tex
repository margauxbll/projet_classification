...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pays\_a\_aider }\OtherTok{\textless{}{-}}\NormalTok{ donnee\_moinsdev[donnee\_moinsdev}\SpecialCharTok{$}\NormalTok{gpecah }\SpecialCharTok{==}\DecValTok{1}\NormalTok{,]}
\FunctionTok{head}\NormalTok{(pays\_a\_aider)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{suggestion-dune-liste-de-pays-uxe0-aider-en-priorituxe9-1}{%
\section{Suggestion d'une liste de pays à aider en
priorité}\label{suggestion-dune-liste-de-pays-uxe0-aider-en-priorituxe9-1}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{aide }\OtherTok{\textless{}{-}}\NormalTok{ donnee\_moinsdev[donnee\_moinsdev}\SpecialCharTok{$}\NormalTok{gpecah}\SpecialCharTok{==}\DecValTok{1}\NormalTok{,]}

\CommentTok{\# Ajouter les noms des lignes comme colonne}
\NormalTok{t }\OtherTok{\textless{}{-}}\NormalTok{ tibble}\SpecialCharTok{::}\FunctionTok{rownames\_to\_column}\NormalTok{(aide, }\AttributeTok{var =} \StringTok{"Nom\_pays"}\NormalTok{)}

\CommentTok{\# Extraire la colonne "x" en tant que vecteur}
\NormalTok{x\_values }\OtherTok{\textless{}{-}} \FunctionTok{pull}\NormalTok{(t, Nom\_pays)}

\CommentTok{\# Afficher les valeurs de la colonne "x" sous forme de liste à puce}
\FunctionTok{cat}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"{-}"}\NormalTok{, x\_values, }\AttributeTok{sep =} \StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Il y a\textquotesingle{}}\NormalTok{, }\FunctionTok{length}\NormalTok{(x\_values), }\StringTok{\textquotesingle{}pays à aider en priorité\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
