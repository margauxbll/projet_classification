...
```{r}
head(donnee)
# Définir la palette de couleurs pour chaque groupe
couleurs <- c("red", "orange", "green", "blue")
...
Caractérisation de la partition obtenue Représentation informative des résultats.
